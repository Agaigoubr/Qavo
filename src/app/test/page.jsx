...
export default function page() {
  return (
    <div className="flex items-center gap-3 absolute top-[30px] left-[25px]">
  ...
  <div className="flex gap-3 ml-6">
    <img className="w-[26px] h-[26px]" alt="Search" src="/frame-2.svg" />
    <img className="w-[26px] h-[26px]" alt="Shopping bag" src="/frame-14.svg" />
  </div>
</div>
